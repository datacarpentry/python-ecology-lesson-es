...
:   es una forma de asignar índices a elementos en una estructura de datos ordenada y secuencial.
    empezando desde cero, es decir, donde el primer elemento de la secuencia tiene el índice cero.
