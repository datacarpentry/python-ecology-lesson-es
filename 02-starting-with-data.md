...
| Columna         | Descripción                           | 
| --------------- | ------------------------------------- |
| record\_id       | identificador único de la observación | 
| month           | mes de observación                    | 
| day             | día de la observación                 | 
| year            | año de la observación                 | 
| plot\_id         | ID de un sitio en particular          | 
| species\_id      | código de dos letras                  | 
| sex             | sexo del animal ("M", "F")            | 
| hindfoot\_length | tamaño de pata en mm                  | 
...
la [Python Data Analysis Library](https://pandas.pydata.org/) (alias Pandas).  La
biblioteca Pandas provee estructuras de datos, genera gráficos de alta
calidad con [matplotlib](https://matplotlib.org/) y se integra de buena forma
con otras bibliotecas que usan **arrays** de [NumPy](https://www.numpy.org/)
...
formato CSV. CSV son las siglas para *Comma-Separated Values*, valores
...
Para más detalles sobre los archivos CSV, ve la lección [Organización de datos en hojas de cálculo](https://www.datacarpentry.org/spreadsheet-ecology-lesson/05-exporting-data/).
Podemos usar la función de Pandas `read_csv`para abrir el archivo directamente en
un [DataFrame](https://pandas.pydata.org/pandas-docs/stable/dsintro.html#dataframe).
...
1. Crear una lista de los IDs de los sitios ("plot\_id") que están en los datos del censo.
...
![](fig/countPerSpecies.png){alt='Peso de especies por sitios'}
...
- [Para mayor información en gráfica con Pandas, visita la siguiente liga.](https://pandas.pydata.org/pandas-docs/stable/visualization.html#basic-plotting-plot)
...
![](fig/stackedBar1.png){alt='Gŕafica de barras apiladas'}
...
![](fig/stackedBar.png){alt='Gráfica de barras apiladas'}
